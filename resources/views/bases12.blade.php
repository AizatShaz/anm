        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
          ...
          <div class="d-flex align-items-center">
            <div class="toggle-icon-wrapper">
              ...
              <div class="d-flex align-items-center py-3"><img class="me-2" src="" alt="" width="40" /><span class="font-sans-serif"></span>
              </div>
            </a>
          </div>
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse" style="top-padding:100px; background-color: white;">
            <div class="container">
              <img class="me-2" src="https://www.majalahsains.com/wp-content/uploads/2012/05/Logo-Agensi-Nuklear-Malaysia.png" alt="" width="40" />
            </div>
            <div class="navbar-vertical-content scrollbar" style="top-padding:100px; background-color: white;" >
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  <!-- parent pages--><a class="nav-link" href="#dashboard" role="button">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-home"></span></span><span class="nav-link-text ps-1">Laman Utama</span>
                    </div>
                  </a>
                </li>
                <li class="nav-item">
          ...
          <footer class="footer">
            <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
              <div class="col-12 col-sm-auto text-center">
                <p class="mb-0 text-600"><span class="d-none d-sm-inline-block"></span><br class="d-sm-none" />PipelineNetwork-Aizat &copy;</p>
              </div>
              <div class="col-12 col-sm-auto text-center">
