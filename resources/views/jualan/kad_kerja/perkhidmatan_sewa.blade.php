...
@section('content')   
<h1>KAD KERJA - PERKHIDMATAN SEWA</h1>
...
<br>
<br>
<label for="">TARIKH SEWA:</label>
<label for="">MULA:</label>
<input type="date" name="" id="">
<br>
<label for="">TAMAT:</label>
<input type="date" name="" id="">
<br>
...
<br>
<br>
<h5>PROSES DAFTAR SEWA SELESAI</h5>
<br>
...
<br>
<br>
<h5>PROSES PROSES SAMPEL SELESAI</h5>
<br>
<label for=“”>TARIKH SIAP :</label>
<input type="date" name="" id="">
<br>
