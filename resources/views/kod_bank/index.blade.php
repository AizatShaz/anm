...
<h2>KOD BANK</h2>
<button style="margin-bottom: 10px" class="btn btn-primary delete_all" data-url="{{ url('bank_DeleteAll') }}">Delete All Selected</button>
<table style="text-align: center">
<thead>
  <tr>
...
<tbody>
  <tr>
    ...
    <form action="/kod_bank/" method="POST" id="new_servis_pusat_khidmat">
      @csrf
    <td> <input name="kod" type="text" class="" onClick="return empty()"></td>
    <td> <input name="nama" type="text" class="" style="width: 400px"></td>
