              ...
              <tbody>
                <tr>
                  ...
                  <form action="/kod_status_syarikat/{{ $kod_status_syarikat -> id }}" method="POST" >
                    @method('PUT')
                    @csrf
                  <td> <input value="{{ $kod_status_syarikat -> kod }}" name="kod" type="text" class="form-control"></td>
                  <td> <input value="{{ $kod_status_syarikat -> nama }}" name="nama" type="text" class="form-control"></td>
                  <td><button class="btn btn-secondary" type="submit" value="submit"><img width="20" src="/kemaskini.png" alt="">KEMASKINI</a></button></td>
                  </form>
                </tr>
              </tbody>
              <tbody>
