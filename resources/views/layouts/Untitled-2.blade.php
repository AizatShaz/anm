...
<nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
    <script>
        ...
        <div class="collapse navbar-collapse" id="navbarVerticalCollapse" style="height:0% background: #2CABE1; width: 100%">
            <div class="navbar-vertical-content scrollbar" id="checklim">
                <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav"> 
                    <div >
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <img id="rcorners" src="nuklear_logo.png" alt="" width="40">
                            </div>
                            <div class="col mb-3">
