          ...
          <form method="POST" action="/permohonan_sebutharga_luaran/">
            ...
            <div id="divinput0" hidden >
              ...
              <select id="sebutharga_jenis_permohonan" name="sebutharga_jenis_permohonan" aria-placeholder="Jenis Permohonan" >
                ...
                <br>
                <br>
                <button class="btn btn-primary" type="button" id="continue1">SETERUSNYA</button>
            </div>
            <div id="divinput1" >
              <br>
              ...
              <button class="btn btn-primary" type="button" id="continue2">SETERUSNYA</button>
            ...
            <table>
              ...
              <button class="btn btn-primary" type="button" id="kembali2">KEMBALI</button>
              <button class="btn btn-primary" type="button" id="continue3">SETERUSNYA</button>
             </div>
             <div id="divinput3">
              <table>
                <tr>
              ...
              <button class="btn btn-primary" type="button" id="kembali3">KEMBALI</button>
              <button class="btn btn-primary" type="button" id="continue4">SETERUSNYA</button>
             </div>
             <div id="divinput4">
        ...
        $.ajax({
            ...
            $.each(data.aos1, function(index,value) {
                $('#harga_perkhidmatan').append(
                  `<tr><td value="${value.id}"data-name="${value.nama}"><a href="/add-to-cart/${value.id}" >${counter}</td><td value="${value.id}" data-name="${value.nama}">${value.nama}</td><td value="${value.id}" data-name="${value.nama}">${value.hargaY}</td><td value="${value.id}" data-name="${value.nama}">${value.unitHarga}</a></td></tr>`
                  );
                counter++;
            });
        });
